...
export default function Layout({ children, currentPageName }) {
  ...
  const isPublicPage = ['Home', 'PrivacyPolicy', 'TermsOfService', 'RefundPolicy', 'PartnerSignup'].includes(currentPageName);
  ...
  const adminNav = [
    ...
    { name: 'RCS Templates', path: 'ClientRCSTemplates', icon: FileText },
