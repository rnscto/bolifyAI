        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <img
                src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/698823c19043e168a5daaa86/5161e7458_WhatsAppImage2026-02-11at44923PM.jpg"
                alt="VaaniAI"
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="tel:+917020609101" className="flex items-center gap-2 hover:text-white transition-colors">
                  <Phone className="w-4 h-4 text-slate-500" />
                  +91-7020609101
                </a>
              </li>
              <li>
                <a href="mailto:sales@vaaniai.io" className="flex items-center gap-2 hover:text-white transition-colors">
