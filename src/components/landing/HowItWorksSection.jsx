        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, i) => {
            ...
            return (
              ...
              >
                {i < steps.length - 1 && (
                  <div className="hidden lg:block absolute top-12 left-[60%] w-[80%] h-px bg-gradient-to-r from-blue-300 to-transparent" />
                )}
                <div className="w-24 h-24 rounded-2xl bg-blue-50 flex items-center justify-center mx-auto mb-5 relative">
